...
echo "Просмотров: ".$rezview_today[0];
echo " Посетителей: ".$rezview_today[1] . PHP_EOL;

$rezview_all = explode(",", $rezview[1]);
echo "Просмотров за все время: ".$rezview_all[0];
echo " Посетителей за все время: ".$rezview_all[1] . PHP_EOL;
?>